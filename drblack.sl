variable fg = "white"; variable bg = "black";
set_color("normal", fg, bg);	       % default fg/bg
set_color("status", "black", "blue");  % status or mode line
set_color("region", "black", "blue");  % for marking regions
set_color("operator", fg, bg);	       % +, -, etc..
set_color("number", "yellow", bg);     % 10, 2.71,... TeX formulas
set_color("comment", "yellow", bg);    % /* comment */
